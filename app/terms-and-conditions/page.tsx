        ...
        <div className="bg-white min-h-screen">
            ...
            <div className="max-w-4xl mx-auto px-4 py-16 space-y-12">
                ...
                <section className="inter-font">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">By using this website, you agree to:</p>
                ...
                <div className="bg-secondary-50 p-8 rounded-xl border-l-8 border-primary shadow-sm">
                    <section className="inter-font">
                        <h2 className="josefin-font text-3xl font-bold primary-text mb-6 uppercase">
                            Membership
                        </h2>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div>
                                <h3 className="josefin-font text-xl font-bold mb-3 primary-text">Eligibility</h3>
                            ...
                            <div>
                                <h3 className="josefin-font text-xl font-bold mb-3 primary-text">Membership Application</h3>
                            ...
                            <div>
                                <h3 className="josefin-font text-xl font-bold mb-3 primary-text">Approval of Membership</h3>
                                <p className="text-gray-700">
                            ...
                            <div>
                                <h3 className="josefin-font text-xl font-bold mb-3 primary-text">Member Responsibilities</h3>
                                <ul className="list-disc pl-6 space-y-1 text-gray-700 text-sm">
                        ...
                        <div className="mt-8 pt-6 border-t border-gray-200">
                            <h3 className="josefin-font text-xl font-bold mb-3 primary-text">Termination of Membership</h3>
                            <p className="text-gray-700">
